...
struct i2c_adapter *i2c_mux_channel_5       = NULL; /* pca9548x-channel 6 */
...
static int e582_48x6q_init(void)
{
    ...
    i2c_mux_channel_5 = i2c_get_adapter(PCA9548_ADAPT_ID_START + 5);
    if(i2c_mux_channel_5 == NULL)
    {
        printk(KERN_INFO "install e582_48x6q board adt7470 failed\n");
        goto install_at24c64;
    }
    
    i2c_client_adt7475 = i2c_new_device(i2c_mux_channel_5, &i2c_dev_adt7475);
...
static void e582_48x6q_exit(void)
{
    ...
    if(i2c_mux_channel_5) {
        i2c_put_adapter(i2c_mux_channel_5);
    }
